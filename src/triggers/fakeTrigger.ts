const subscribeHook = (z: any, bundle: any) => {
  ...
  return z.request(options)
    .then((response: any) => JSON.parse(response.content));
};

const unsubscribeHook = (z: any, bundle: any) => {
...
const getRecipe = (z: any, bundle: any) => {
...
const getFallbackRealRecipe = (z: any, bundle: any) => {
